...
### 8. 상점 시스템 (Stage 2 클리어 후)

#### 오픈 조건
- Stage 2 클리어 후부터 매 스테이지 클리어 시 상점 오픈
...
- `addDeadZonesForStage4()` - Stage 5 데드존 2개 추가
...
| 2 | 120ms | 없음 | 2회 | O | X | 십자가 후레쉬, 텔레포트 강화 |
| 3 | 110ms | 없음 | 2회 | O | X | **보스 스테이지** (1000점 보너스) |
...
- `currentStage >= 2` - Stage 2 클리어 후 상점 오픈
